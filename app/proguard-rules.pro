...
-keep class com.ytfu.yuntaifawu.ui.updatapk.**{*;}
-keep class update.**{*;}
-keep class model.**{*;}
-keep class listener.**{*;}
-keep class extension.**{*;}
-keep class constacne.**{*;}
-keep class com.teprinciple.updateapputils.**{*;}
...
-keep class com.bun.** { *; }
-dontwarn com.bun.**
-keep class  com.core.ui.** { *; }
-dontwarn  com.core.ui.**

-keep class com.core.ui.**{*;}
-keep class * extends com.core.ui.mvp.view.BasicMVPRefreshView
