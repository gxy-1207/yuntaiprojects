package com.ytfu.yuntaifawu.ui.lvshiwenti.header;
 ...
 * @Des 咨询详情悬赏header
 */
public class LawyerConsultationDetailsHeader extends BaseHeaderController<ConsultationDetailsBean.ContentBean> {

    public LawyerConsultationDetailsHeader(Context mContext) {
        super(mContext);
    }
