...
*
*/
public class SimilarContractAdaper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private List<ContractDetailsBean.ContractListBean> mList;

    public SimilarContractAdaper(Context mContext) {
        this.mContext = mContext;
        mList = new ArrayList<>();
    }
  public void setmList(List<ContractDetailsBean.ContractListBean> mList){
        this.mList = mList;
        notifyDataSetChanged();
  }

  public void addmlist(List<ContractDetailsBean.ContractListBean> list){
            if(!list.isEmpty()){
                mList.addAll(list);
                notifyDataSetChanged();
            }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ContractDetailsBean.ContractListBean contractListBean = mList.get(position);
