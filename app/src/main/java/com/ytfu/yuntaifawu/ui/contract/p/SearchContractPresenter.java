...
public class SearchContractPresenter extends BaseRefreshPresenter<BaseRefreshView<ContractDatalistBean.ListBean>> {
    public void setSearchContractList(boolean isLoadMor,String keyword,int page){
        Observable<ContractDatalistBean> observable = createService(ApiService.class).getSearchContractList(keyword, page);
        requestRemote(observable, new BaseRxObserver<ContractDatalistBean>() {
            ...
            public void onErrorImpl(String errorMessage) {
                Logger.e("setSearchContractList",errorMessage);
            }
        });
    }
} 