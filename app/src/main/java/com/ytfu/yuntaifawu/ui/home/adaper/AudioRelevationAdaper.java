...
*
*/
public class AudioRelevationAdaper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private List<ContractDetailsBean.AudioListBean> mList;

    public AudioRelevationAdaper(Context mContext) {
        this.mContext = mContext;
        mList = new ArrayList<>();
    }

    public void setList(List<ContractDetailsBean.AudioListBean> list) {
        this.mList = list;
        notifyDataSetChanged();
    }

    public void addList(List<ContractDetailsBean.AudioListBean> list) {
        if (!list.isEmpty()) {
            mList.addAll(list);
            notifyDataSetChanged();
        }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        ContractDetailsBean.AudioListBean audioListBean = mList.get(position);
