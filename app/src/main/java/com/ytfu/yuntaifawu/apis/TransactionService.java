...
public interface TransactionService {
    ...
    @FormUrlEncoded
    Observable<TransactionResponseBean> getTransaction(
            @Field("UserID") String uid, @Field("Page") int page, @Field("Size") int size);
    ...
    @FormUrlEncoded
    Observable<UnbindAliResponse> unbindAliPay(
            @Field("UserID") String uid, @Field("Type") int type);
    ...
    @POST("surplus/bindingZFBaccount")
    @FormUrlEncoded
    Observable<UnbindAliResponse> bindAliPay(
    ...
    @FormUrlEncoded
    Observable<WithdrawResponseBean> withdraw(
            @Field("UserID") String uid, @Field("Money") String money);
    ...
    @FormUrlEncoded
    Observable<FeeResponse> chargeFee(
            @Field("yonghu") String toUserId,
            @Field("lvshi") String selfId,
            @Field("price") String price);

    /**
     * 提现成功 https://yuntaifawu.com/api/surplus/get_transaction
     *
     * @param user_id 用户id
    ...
    @FormUrlEncoded
    Observable<WithdrawSuccessBean> setWithdrawSucccess(
            @Field("user_id") String user_id, @Field("tixian_id") String tixian_id);

    /** 获取七牛云的token http://ceshi.yuntaifawu.com/api/qiniu/get_token */
    @POST("qiniu/get_token")
    Observable<GetQiniuTokenBean> setQiNiuToken();
}
