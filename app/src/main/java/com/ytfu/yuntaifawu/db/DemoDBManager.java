    ...
    synchronized public Map<String, EaseUser> getContactList() {
        ...
        if (db.isOpen()) {
            ...
            while (cursor.moveToNext()) {
                ...
                if (username.equals(AppConstant.NEW_FRIENDS_USERNAME) || username.equals(AppConstant.GROUP_USERNAME)
                        || username.equals(AppConstant.CHAT_ROOM)|| username.equals(AppConstant.CHAT_ROBOT)) {
