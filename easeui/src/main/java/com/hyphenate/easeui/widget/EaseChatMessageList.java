...
//        View headerView = View.inflate(getContext(), R.layout.ease_row_received_header_card, null);
       listView.addHeaderView(view);
    }
    public void addHeaderFw(View view){
//        View headerView = View.inflate(getContext(), R.layout.ease_row_received_header_card, null);
        listView.addHeaderView(view);
    }
    /**
    ...
    public void init(String toChatUsername, int chatType, EaseCustomChatRowProvider customChatRowProvider) {
        ...
        messageAdapter = new EaseMessageAdapter(context,toUserPic, toChatUsername, chatType, listView);
