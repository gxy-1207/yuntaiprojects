...
public class EaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        edittext_layout.setBackgroundResource(R.drawable.edit_send_message_shape);
        
        buttonSend.setOnClickListener(this);
//        buttonSend.setEnabled(false);
//        buttonSend.setBackgroundResource(R.drawable.ease_chat_send_btn_end_shape);
...
//        // 新建一个可以添加属性的文本对象
//        SpannableString ss = new SpannableString("请输入消息内容...");
//        // 新建一个属性对象,设置文字的大小
//        AbsoluteSizeSpan ass = new AbsoluteSizeSpan(14,true);
//        // 附加属性到文本
//        ss.setSpan(ass, 0, ss.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
//        editText.setText(new SpannableString(ss));
...
//                    buttonSend.setBackgroundResource(R.drawable.ease_chat_send_btn_shape);
//                    buttonSend.setBackgroundColor(Color.parseColor("#44a2f7"));
                } else {
...
//                    buttonSend.setEnabled(false);
//                    buttonSend.setBackgroundResource(R.drawable.ease_chat_send_btn_end_shape);
//                    buttonSend.setBackgroundColor(Color.parseColor("#cccccc"));
                }
