 ...
 * @Des 自定义扩展消息
 */
public class EaseChatRowPayYf extends EaseChatRow {

    private TextView tv_hx_price;
    private EaseImageView iv_userhead;

    public EaseChatRowPayYf(Context context, EMMessage message, int position, BaseAdapter adapter) {
        super(context, message, position, adapter);
    }

    @Override
    protected void onInflateView() {
        inflater.inflate(message.direct() == EMMessage.Direct.RECEIVE ? R.layout.ease_row_received_sure_pay_yf : R.layout.ease_row_sent_payed, this);
    }
