...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public interface OnMessageCallback {
        void onSuccess(EMMessage message, String content);

        void onError(int code, String msg);
    }

    private OnMessageCallback cb = null;

    public void setOnMessageCallback(OnMessageCallback cb) {
        this.cb = cb;
    }
    ...
    protected void initView() {
        ...
        messageList.setToUserPic(picurl);
    ...
    protected void onConversationInit() {
        conversation = EMClient.getInstance().chatManager().getConversation(toChatUsername.toLowerCase(), EaseCommonUtils.getConversationType(chatType), true);
        conversation.markAllMessagesAsRead();
        // the number of messages loaded into conversation is getChatOptions().getNumberOfMessagesLoaded
        // you can change this number

        Log.e("TAG", "Is roaming..................." + isRoaming);
    ...
    public void onMessageReceived(List<EMMessage> messages) {
        EMLog.i(TAG, "Receive message: " + messages);
    ...
    public void sendTextMessage(final String content) {
        if (EaseAtMessageHelper.get().containsAtUsername(content)) {
            ...
            final EMMessage message = EMMessage.createTxtSendMessage(content, toChatUsername.toLowerCase());
    ...
    private void sendAtMessage(String content) {
        ...
        EMMessage message = EMMessage.createTxtSendMessage(content, toChatUsername.toLowerCase());
        EMGroup group = EMClient.getInstance().groupManager().getGroup(toChatUsername);
    ...
    protected void sendMessage(final EMMessage message) {
        ...
        message.setMessageStatusCallback(new EMCallBack() {
            ...
            public void onSuccess() {
                if (cb != null) {
                    if (message.getType() == EMMessage.Type.TXT) {
                        ...
                        cb.onSuccess(message, body.getMessage());
                    } else {
            ...
            public void onError(int i, String s) {
                ...
                messageStatusCallback.onError(i, s);
            }

            @Override
            public void onProgress(int i, String s) {
                messageStatusCallback.onProgress(i, s);
            }
        });
