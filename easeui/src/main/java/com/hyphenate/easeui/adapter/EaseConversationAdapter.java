...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        if (null == convertView) {//
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.ease_row_chat_history_new, parent, false);
        }
        ViewHolder holder = (ViewHolder) convertView.getTag();
        if (null == holder) {
            holder = new ViewHolder();
            holder.avatar = convertView.findViewById(R.id.iv_lawyer_head);
            holder.name = convertView.findViewById(R.id.tv_lawyer_name);
            holder.message = convertView.findViewById(R.id.tv_lawyer_last);
            holder.time = convertView.findViewById(R.id.tv_lawyer_time);
            holder.unreadLabel = convertView.findViewById(R.id.tv_lawyer_unread);
